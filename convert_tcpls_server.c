...
UNUSED static int _handle_bind(void){
  return 0;
}

UNUSED static int _handle_listen(void){
  return 0;
}

UNUSED static int _handle_accept(void){
  return 0;
}
...
_hook(long syscall_number, long arg0, long arg1,  long arg2, long UNUSED arg3,
  ...
  switch(syscall_number){
    ...
    case SYS_bind:
      return _handle_bind();
    case SYS_listen:
      return _handle_listen();
    case SYS_accept:
      return _handle_accept();
    case SYS_send:
      return _handle_send();
    case SYS_recv:
      return _handle_recv();
